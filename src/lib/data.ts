...
export const courses: Course[] = [
  {
    ...
    imageHint: 'software testing checklist bug tracking interface code',
  ...
  },
  {
    ...
    imageHint: 'java programming code syntax on computer screen',
  ...
  },
  {
    ...
    imageHint: 'aws cloud computing architecture diagrams server infrastructure',
  ...
  },
  {
    ...
    imageHint: 'devops kubernetes docker containers infrastructure code terminal',
  ...
  },
  {
    ...
    imageHint: 'data engineering pipelines analytics dashboard charts code',
  ...
  },
  {
    ...
    imageHint: 'playwright automation testing cross browser code editor',

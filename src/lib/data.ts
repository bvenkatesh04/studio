...
export const courses: Course[] = [
  {
    ...
    imageHint: 'software testing checklist bug tracking interface',
  ...
  },
  {
    ...
    imageHint: 'java programming code syntax on screen',
  ...
  },
  {
    ...
    imageHint: 'aws cloud computing architecture diagrams',
  ...
  },
  {
    ...
    imageHint: 'selenium automation testing browser code',
    modules: sampleModulesTech,
  ...
  },
  {
    ...
    imageHint: 'cypress modern web testing framework code',
